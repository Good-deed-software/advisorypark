				...
				<div class="post-project-fields">
					<form action="{{route('requirements')}}" method="post">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="inp-field">
									<select name="category[]" class="multiple" id="category_r" multiple>
							...
							<div class="col-lg-12">
								<div class="inp-field">
									<select name="skill[]" class="multiple" id="skill_r" multiple >
									@foreach($skills as $s)
							...
							<div class="col-lg-12">
								<div class="inp-field">
									<select name="tag[]" class="form-control multiple" id="tag_r" multiple>
									@foreach($tags as $t)
				...
				<div class="post-project-fields">
					<form action="{{route('posts')}}" method="post">
						...
						<div class="row">
						    ...
						    <div class="col-lg-12">
								<div class="inp-field">
									<select name="category[]" class="multiple" id="category_p" multiple>
									@foreach($categories as $c)
										<option value="{{$c->id}}" data-val="{{$c->name}}">{{$c->name}}</option>
									@endforeach
									</select>
							...
							<div class="col-lg-12">
								<div class="inp-field">
									<select name="tag[]" class="multiple" id="tag_p" multiple>
									@foreach($tags as $t)
										<option value="{{$t->id}}" data-val="{{$t->name}}">{{$t->name}}</option>
									@endforeach
									</select>
