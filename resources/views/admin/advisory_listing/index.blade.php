                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table id="example" class="table table-bordered">
                      ...
                      <tbody>
                     @foreach($advisory_listing as $data)
                        <tr>
                          ...
                          <td> @foreach($v as $k) {{$k->name}} @endforeach  </td>
                          <td>
                              <a href="{{route('advisory_listing.edit',$data->id)}}" type="button" style="padding:0.800rem 1.5rem !important;" class="btn btn-gradient-dark btn-icon-text"><i class="mdi mdi-pencil btn-icon-append"></i></a>
                              <a href="{{route('advisory_listing.delete',$data->id)}}" type="button" style="padding:0.800rem 1.5rem !important;" class="btn btn-gradient-danger btn-icon-text"><i class="mdi mdi-delete btn-icon-append"></i></a>
                          </td>
                        </tr>
                       @endforeach
                      </tbody>
