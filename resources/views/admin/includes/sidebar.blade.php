<nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic4" aria-expanded="false" aria-controls="ui-basic3">
                <span class="menu-title">Advisory Listing</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-format-list-checkbox menu-icon"></i>
              </a>
              <div class="collapse" id="ui-basic4">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('advisory_listing.create')}}">Add</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('advisory_listing')}}">List</a></li>
                </ul>
              </div>
            </li>
             <!--  <li class="nav-item">
